<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-[#70ff79]">Hello World, I'm</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Putu Danan</h1>
      <div class="py-2">
        <h1
          class="typewrite text-xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-[#70ff79] md:text-2xl fadein-up"
          ref="typewriter">
    ...
    <div class="flex justify-center md:justify-start fadein-right">
      <img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-[#70ff79] pict" src="/img/aik.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Front-End Developer", "UI/UX Designer","Informatics Student", "Tech Enthusiast"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
