      ...
      items: [
        {
          ...
          imageUrl: 'portofolio',
          status: 'A personal website that showcases a portfolio of front-end development and UI/UX design projects, reflecting expertise and creativity in creating attractive and responsive interfaces.',
          tech: 'VueJS 3, Tailwind',
          github: 'https://github.com/PutuDanan/portofolio',
          demo: 'null'
        },
        {
          id: 2,
          name: 'Reisenesia',
          imageUrl: 'reisenesia',
          status: 'Reisenesia is a trusted partner offering smart itineraries that bring you closer to Indonesia natural beauty and culture for unforgettable adventures.',
          tech: 'VueJS 3, Tailwind',
          github: 'https://github.com/TSD-House/pkm-reisenesia-frontend-happiness',
          demo: 'https://www.reisenesia.com/'
        },
        {
          id: 3,
          name: 'Web Destination',
          imageUrl: 'destination',
          status: 'The Web Destination that I created is an informative platform that presents the beauty and tourist attractions of Nusa Lembongan through an attractive and user-friendly design.',
          tech: 'Bootstrap',
          github: 'https://github.com/PutuDanan/icikiwir.github.io',
          demo: 'https://putudanan.github.io/icikiwir.github.io/'
        },
        {
          id: 4,
          name: 'Manajemen Toko',
          imageUrl: 'dashboard',
          status: 'Toko Sebelah is a shop management website that facilitates efficient management of goods and transactions in one integrated platform.',
          tech: 'PHP, Laravel',
          github: 'https://github.com/PutuDanan/kakiang_gallery.github.io',
          demo: 'null'
        },
        {
          id: 5,
          name: 'Design Web & Mobile',
          imageUrl: 'design_figma',
          status: 'My website and mobile designs in Figma feature intuitive and aesthetic interfaces with easy navigation and responsiveness.',
          tech: 'Figma',
          github: 'null',
          demo: 'https://www.figma.com/design/k04G5Rx5oE55LnSgYNLpgR/Kumpulan-Desain-Web-%26-Mobile?node-id=0-1&t=E7rH8f8xta1kojEi-1'
        }
      ]
    };
  }
    ...
    <article data-page="about">
      <header>
        <div
          ...
          <h4 class="text-base font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-[#70ff79]">
              ...
              <div
                ...
                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="w-full text-left text-[10px] text-[#c1c1c1] md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                  <div class="w-full mt-4 text-normal text-sm text-left text-[#70ff79]">
                    {{ item.tech }}
                  </div>
