    ...
    return {
      ...
      tools: [
        ...
        },
        {
          id: 3,
          name: "Figma",
          imageUrl: "https://cdn-images-1.medium.com/max/1600/1*6XgfDCVn81AYX68Xvd2I-g@2x.png",
          status: "Design",
        },
        {
          id: 4,
    ...
    <article data-page="about">
      <header>
        ...
        >
          About Me &nbsp;
          <div
            class="h-[1px] w-32 bg-[#70ff79] md:w-96 aos-init aos-animate"
      ...
      >
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Putu Danan. I'm a web
            developer from Bali, Badung. I'm a student at INSTIKI (Institut
            Bisnis dan Teknologi Indonesia) and I've been a tech enthusiast
            since high school. Right now, I'm pretty skilled in front-end
            development and UI/UX design. I've worked on a few small projects on
            my own, and now I'm having a blast working on my first team project
            with lecturers and friends.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; I'm still learning a lot, but my goal is to
            become a professional front-end developer and work at a company that
            pays really well. Basically, I want to keep creating awesome stuff
            in the tech world!
          </p>
        </div>
      </section>
  ...
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-amber-50 mx-3">
    <article data-page="about">
      <header>
        ...
        >
          <div
            class="h-[1px] w-10 bg-[#70ff79] md:w-20 aos-init aos-animate"
            data-aos="zoom-in-left"
            data-aos-duration="600"
          ></div>
          &nbsp; Skills
          ...
          >
            <li class="mr-2">
              <button
                ...
                :class="{
                  'text-[#70ff79] bg-[#70ff79] bg-opacity-10': activeTab === 1,
                }"
                @click="activeTab = 1"
              >
                Tech Stack
            ...
            <li class="mr-2">
              <button
                class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{
                  'text-[#70ff79] bg-[#70ff79] bg-opacity-10': activeTab === 2,
                }"
                @click="activeTab = 2"
              >
                Tools
        ...
        <div v-show="activeTab === 1">
          ...
          >
            <div v-for="item in tech" :key="item.id">
              <div
                class="item-tech flex cursor-pointer items-center gap-2 rounded border border-[#70ff79] px-2 py-2 hover:bg-[#70ff79] hover:bg-opacity-10 md:gap-3 lg:px-3"
              >
                <div
            ...
            <div v-for="item in tools" :key="item.id">
              ...
              >
                ...
                <div class="flex items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div
                    class="status-tech opacity-0 absolute mt-5 text-[10px] text-[#70ff79] transition-all duration-300 md:text-xs lg:text-sm"
                  >
                    {{ item.status }}
                  </div>
                </div>
